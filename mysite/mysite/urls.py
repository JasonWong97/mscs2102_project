...
urlpatterns = [
    ...
    path('apis/crypto_list_data', views.get_crypto_list_data),   # get crypto list data
    path('apis/get_sentiment_data', views.get_sentiment_data),   # get crypto list data
    path('apis/get_history_data', views.get_history_data),   # get crypto list data
    path('apis/get_realtime_price', views.get_realtime_price),   # get crypto list data
]
