...
def process_rdd(time, rdd):
    ...
    try:
       # Get spark sql singleton context from the current context
        ...
        hashtag_counts_df.coalesce(1).write.format('com.databricks.spark.csv').mode('overwrite').option("header", "true").csv("/Users/wengjiacheng/Documents/apitest/aasdas/hashtag_file.csv") 
        ...
        country_counts_df.coalesce(1).write.format('com.databricks.spark.csv').mode('overwrite').option("header", "true").csv("/Users/wengjiacheng/Documents/apitest/aasdas/country_file.csv")
        ...
        device_df.show()
        device_df.coalesce(1).write.format('com.databricks.spark.csv').mode('overwrite').option("header", "true").csv("/Users/wengjiacheng/Documents/apitest/aasdas/device_file.csv")
